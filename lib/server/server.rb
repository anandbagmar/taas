...
get "/create_simple_live_sale/:name/:no_of_listing" do
   command_output = CommandRunner.execute("/home/tworker/work/livesale-automation","bundle exec cucumber --tags @create_live_sale taas_sale_name=#{params[:name]} taas_number_of_listing=#{params[:no_of_listing]}")
